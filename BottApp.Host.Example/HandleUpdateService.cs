...
namespace BottApp.Host.Example
{
    public class HandleUpdateService
    {
        ...
        private readonly ILogger<Services.HandleUpdateService> _logger;

        public HandleUpdateService(ITelegramBotClient botClient, ILogger<Services.HandleUpdateService> logger)
        {
